...
#define _nstates1	33	/* Server */
#define minseq1	44
#define maxseq1	75
#define _endstate1	32

#define _nstates0	45	/* Client */
#define minseq0	0
#define maxseq0	43
...
#define Air1	(sizeof(P1) - Offsetof(P1, received_data) - 1*sizeof(int))
...
#define Air0	(sizeof(P0) - Offsetof(P0, seq_num) - 1*sizeof(int))
