...
#define _nstates0	30	/* check_triangle_type */
#define minseq0	0
#define maxseq0	28
...
#define Pcheck_triangle_type	((P0 *)_this)
typedef struct P0 { /* check_triangle_type */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, _1_1_2_tmp) - 1*sizeof(int))
